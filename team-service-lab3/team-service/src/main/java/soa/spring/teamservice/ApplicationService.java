...
public class ApplicationService {
    ...
    public Response addHumanBeingToTeam(String teamId, String humanBeingId) {
        System.out.println("add humanbeing to team");
